...
ActiveRecord::Schema.define(version: 2019_09_19_093514) do
  ...
  create_table "practiciens", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "telephone_prive"
    t.index ["user_id"], name: "index_practiciens_on_user_id"
  end
  ...
  add_foreign_key "practiciens", "users"
end
